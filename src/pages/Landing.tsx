  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 py-12">
        ...
        {/* Headline */}
        <h1 className="text-3xl sm:text-5xl font-bold text-foreground text-center mb-2">
          ai-powered running routes
        </h1>
        ...
        {/* Email Signup */}
        {!isSubmitted ? (
          <form onSubmit={handleSubmit} className="w-full max-w-md flex gap-2 mb-12">
            <Input
              type="email"
          ...
          <div className="flex items-center gap-2 text-primary mb-12 bg-primary/10 px-6 py-3 rounded-lg">
      ...
      <footer className="border-t border-border py-6 px-4">
        <div className="max-w-4xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            <a
              href="https://instagram.com/runlap"
              target="_blank"
