  ...
  return <div className="min-h-screen bg-background px-4 py-8">
      <div className="max-w-md mx-auto space-y-6 animate-fade-in">
        ...
        <Card className="shadow-soft border-border/50">
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <Input id="distance" type="number" value={distance} onChange={e => setDistance(e.target.value)} placeholder="Enter distance" className="text-lg" min="0.1" step="0.1" />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-2">
                ...
                <Switch id="unit-toggle" checked={!isKm} onCheckedChange={checked => setIsKm(!checked)} />
        ...
        <Card className="shadow-soft border-border/50">
          ...
          <CardContent className="space-y-4">
            {selectedLocation && <div className="p-3 bg-secondary rounded-lg">
                <div className="flex items-center space-x-2">
            ...
            <div className="grid grid-cols-1 gap-3">
              <Button variant="outline" onClick={handleUseCurrentLocation} className="h-12 justify-start" disabled={isGenerating}>
                <Locate className="w-5 h-5 mr-3" />
                Use my current location
              </Button>
              
              <Button variant="outline" onClick={handleChooseOnMap} className="h-12 justify-start" disabled={isGenerating}>
        ...
        {/* Generate Button */}
        <Button onClick={handleGenerate} disabled={isGenerating || !distance || !selectedLocation} className="w-full h-14 text-lg font-semibold shadow-medium hover:shadow-strong transition-all duration-300" size="lg">
